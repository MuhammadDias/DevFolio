  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-[#B3B3B3] text-sm mt-1">Manage your portfolio content</p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        {[
          ...
          <div key={s.label} className="card-dark text-center">
            ...
            <div className="text-xs text-[#B3B3B3] mt-1">{s.label}</div>
          </div>
        ))}
      </div>

      {/* Public URL banner */}
      <div className="mb-8 px-5 py-4 rounded-xl bg-[#1DB954]/10 border border-[#1DB954]/25 flex items-center justify-between gap-4">
        <div>
          <p className="text-xs font-semibold text-[#1DB954] uppercase tracking-wider mb-0.5">Your public portfolio</p>
